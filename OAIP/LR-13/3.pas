...
var
  ...
  index, n: integer;
begin
  assign(vesFile, 'D:\\основы программирования и алгортмизации\\лаба 13\\vesch.txt');    
  assign(nechFile, 'D:\\основы программирования и алгортмизации\\лаба 13\\nechyot.txt');        
  assign(chFile, 'D:\\основы программирования и алгортмизации\\лаба 13\\chyot.txt');        
  rewrite(vesFile);  
